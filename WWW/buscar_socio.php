...
$dao = new DAO_socios();
$socios =  $dao -> MostrarSocios($busqueda);
?>
 ...
 <div class="contenido">
        <div class="search-container">
            ...
            <?php foreach ($socios as $socio): ?>
             <div class="book-item">
                <div class="name-socio"><?php echo htmlspecialchars($socio['nombre']);?></div>
                <div class="socio-info"><strong>DNI:</strong><?php echo htmlspecialchars($socio['dni']);?></div>
                <div class="socio-info"><strong>Apellido:</strong><?php echo htmlspecialchars($socio['apellido']);?></div>
                <div class="socio-info"><strong>Telefono:</strong><?php echo htmlspecialchars($socio['telefono']);?></div>
                <div class="socio-info"><strong>Direccion:</strong><?php echo htmlspecialchars($socio['direccion']);?></div>
            </div>
             <?php endforeach; ?>
        </div>
    </div>
